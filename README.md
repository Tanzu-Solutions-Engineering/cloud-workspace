...
Clone the GIT repository to your local machine. On the command line issue the following command:
    ...
    git clone https://github.com/Pivotal-Field-Engineering/cloud-workspace.git

This command will copy the code in the repository to your local machine, creating a directory named `cloud-workspace`. All actions will now be done inside this directory.
